...
def main():
    ...
    with torch.no_grad():
        for idx, data_dict in enumerate(demo_dataset):
            ...
            print("pred_dict {}".format(pred_dicts))
            # pred_dicts
            ...
            """
            pred_dicts[0]['pred_boxes'][0] = torch.Tensor([12.903466205440997, 
                                              1.7985024069324398, 
                                              -0.12958706499999995,
                                                3.960664787044129, 
                                                0.7349037062154792,
            ...
            pred_dicts[0]['pred_boxes'][1] = torch.Tensor([3.538035546403277,
                                                            7.1863756253344855,
                                                              -0.38653041500000007,
                                                                1.9115410329659586,
                                                                  1.912086771297233,
                                                                    1.2659131700000001
                                                                    , 4.4055678978318194])
            pred_dicts[0]['pred_boxes'][2] = torch.Tensor([1.77804997796507,
                                                            2.816582019129339,
                                                              -0.47726178499999994,
                                                                2.54246180851368,
                                                                  0.7011152819509079,
